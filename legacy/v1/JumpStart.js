...
jumpStart.prototype.initiate = function()
{
	...
	html += "<img src='legacy/v1/misc/" + logo + "' id='loadingLogo' onload='var elem = document.getElementById(\"loadingSlate\"); if( typeof elem.loadedImageCount === \"undefined\" ) elem.loadedImageCount = 0; elem.loadedImageCount++; if( elem.loadedImageCount == " + imgCount + " ) { elem.className = \"zoomIntoLoading\"; elem.style.display = \"block\"; JumpStart.finishInit(); }' />";
	//html += "<img src='legacy/v1/misc/jumpstartlogo.png' id='loadingLogo' />";
	html += "</td></tr><tr><td align='center' valign='top' height='100'>";
	html += "<div id='loadingMsg'>Initializing...</div>";
	html += "</td></tr></table>";

	var loadingElem = "<div id='loadingRing' style='position: absolute; top: 0; bottom: 0; left: 0; right: 0;'><table width='100%' height='100%'><tr><td align='center' valign='middle'><img src='legacy/v1/misc/loading.png' class='spinningImage' onload='var elem = document.getElementById(\"loadingSlate\"); if( typeof elem.loadedImageCount === \"undefined\" ) elem.loadedImageCount = 0; elem.loadedImageCount++; if( elem.loadedImageCount == " + imgCount + " ) { elem.className = \"zoomIntoLoading\"; elem.style.display = \"block\"; JumpStart.finishInit(); }' /></td></tr></table></div></div>";
	//var loadingElem = "<div id='loadingRing' style='position: absolute; top: 0; bottom: 0; left: 0; right: 0;'><table width='100%' height='100%'><tr><td align='center' valign='middle'><img src='legacy/v1/misc/loading.png' class='spinningImage' /></td></tr></table></div></div>";
	html += loadingElem;
...
//		this.materialCreator.crossOrigin = 'anonymous';
	...
	{
		// Load our crosshair
		this.loadModels("legacy/v1/models/JumpStart/crosshair.obj").then(function()
		{
			// Spawn it in
			var crosshair = JumpStart.spawnInstance("legacy/v1/models/JumpStart/crosshair.obj");
...
/*
	...
	*/
	...
	if( models.indexOf("legacy/v1/models/JumpStart/crosshair.obj") >= 0 )
...
jumpStartModelLoader.prototype.onModelLoaded = function(fileName, loadedObject, batchName)
{
	...
	for( x in JumpStart.models )
	{
		...
		if( JumpStart.models[x].fileName === "legacy/v1/models/JumpStart/crosshair.obj" )
			engineBatch = true;
