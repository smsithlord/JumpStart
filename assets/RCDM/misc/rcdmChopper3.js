jumpStartBehavior({
	"rcdmChopper3":
	{
		...
		{
			this.addEventListener("spawn", jumpStart.behaviors.rcdmChopper3.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmChopper3.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmChopper3");
