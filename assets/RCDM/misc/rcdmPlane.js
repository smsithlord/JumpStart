	...
	"rcdmPlane":
	{
		"applyBehavior": function(options)
		{
			if( this.ownerID === jumpStart.localUser.userID )
				this.syncData.rcdm.lerpSpeed = 20.0;
			
			this.addEventListener("spawn", jumpStart.behaviors.rcdmPlane.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmPlane.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmPlane");
