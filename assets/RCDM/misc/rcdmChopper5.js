jumpStartBehavior({
	"rcdmChopper5":
	{
		"applyBehavior": function(options)
		{
			...
			//	this.syncData.rcdm.lerpSpeed = 280.0;

			this.addEventListener("spawn", jumpStart.behaviors.rcdmChopper5.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmChopper5.tickBehavior);
			return true;
		},
