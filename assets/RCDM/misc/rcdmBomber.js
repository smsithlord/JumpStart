	...
	"rcdmBomber":
	{
		"applyBehavior": function(options)
		{
			if( this.ownerID === jumpStart.localUser.userID )
				this.syncData.rcdm.lerpSpeed = 80.0;
			
			this.addEventListener("spawn", jumpStart.behaviors.rcdmBomber.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmBomber.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmBomber");
