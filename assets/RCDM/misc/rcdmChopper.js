jumpStartBehavior({
	"rcdmChopper":
	{
		...
		{
			this.addEventListener("spawn", jumpStart.behaviors.rcdmChopper.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmChopper.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmChopper");
