jumpStartBehavior({
	"rcdmPlane2":
	{
		"applyBehavior": function(options)
		{
			...
			this.addEventListener("spawn", jumpStart.behaviors.rcdmPlane2.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmPlane2.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmPlane2");
		...
		"tickBehavior": function()
		{
			...
			if( !!jumpStart.gamepad && ship.ownerID === jumpStart.localUser.userID )
			{
				...
				var idleSpeed = new THREE.Vector3(0, 0, 400.0);
