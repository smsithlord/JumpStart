jumpStartBehavior({
	"rcdmChopper4":
	{
		...
		{
			this.addEventListener("spawn", jumpStart.behaviors.rcdmChopper4.spawnBehavior);
			this.addEventListener("tick", jumpStart.behaviors.rcdmChopper4.tickBehavior);
			return true;
		},
		"spawnBehavior": function(isInitialSync)
		{
			var vehicleType = jumpStart.behaviors.rcdm.getVehicleType("rcdmChopper4");
			...
			// do it again, to set the color of stuff
			/*
			for( x in this.userData.rcdm.parts )
			{
				...
				part = this.userData.rcdm.parts[x];
				if( part.)
			}
		*/
